# Contributing to leaf.magic

This outlines how to propose a change to leaf.magic.
...
issue and make sure a package author agrees that it’s needed. If you’ve
found a bug, please file an issue that illustrates the bug with a
minimal [reprex](https://reprex.tidyverse.org/) (this will also help you
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("jack-davison/leaf.magic", fork = TRUE)`.
...
- For user-facing changes, place a bullet under the appropriate,
  second-level header; Breaking Changes, New Features, or Bug Fixes.

### Code/API style

- New code should follow a similar style to
  [leaflet](https://rstudio.github.io/leaflet/) (e.g., `camelCase` over
  `snake_case`); users should ideally not *feel* like they’re using a
  different package to vanilla
...
Code of
Conduct](https://jack-davison.github.io/leaf.magic/CODE_OF_CONDUCT.md).
